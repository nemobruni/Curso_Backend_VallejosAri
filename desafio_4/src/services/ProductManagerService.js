...
export class ProductManager {
  ...
  addProduct = (newProduct) => {
    ...
    if (poseeCamposObligatorios == false) {
      return {
        error: true,
        message: "El producto no posee todos los campos obligatorios",
      };
    }
    ...
    if (sameCodeFound) {
      ...
      return { error: true, message: "Un producto con este codigo ya existe" };
    } else {
      ...
      return { error: false, message: "producto creado exitosamente" };
    }
  };
